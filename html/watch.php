					...
					<div class="row">
						<div id="player" style="width: 100%;">
							<div class="video-player">
								<video id="video" loop autoplay width="100%" controls></video>
							</div>
							<div class="video-detile">
								<div class="title-video">
									<p style="font-weight: bold; font-size: 15px;">Video Title Data Test Oke</p>
								</div>
								<div class="views-video">
									<p style="font-size: 15px;">150 x ditonton</p>
								</div>
							</div>
						</div>
					</div>
